...
-- -----------------------------------------------------
-- Table `Drueckler3DDrucke`.`DirectDebit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`DirectDebit` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `iban` VARCHAR(22) NOT NULL,
  `ibanShort` VARCHAR(22) NOT NULL,
  `owner` VARCHAR(50) NOT NULL,
  `mandate` TINYINT NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `Drueckler3DDrucke`.`Bill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`Bill` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `Drueckler3DDrucke`.`Paypal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`Paypal` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`PaymentData` (
  ...
  `DirectDebit_id` INT NULL,
  `Bill_id` INT NULL,
  `Paypal_id` INT NULL,
  `preferedPaymentMethod` VARCHAR(2) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_PaymentData_CreditCard1_idx` (`CreditCard_id` ASC),
  UNIQUE INDEX `CreditCard_id_UNIQUE` (`CreditCard_id` ASC),
  INDEX `fk_PaymentData_DirectDebit1_idx` (`DirectDebit_id` ASC),
  INDEX `fk_PaymentData_Bill1_idx` (`Bill_id` ASC),
  UNIQUE INDEX `Bill_id_UNIQUE` (`Bill_id` ASC),
  UNIQUE INDEX `DirectDebit_id_UNIQUE` (`DirectDebit_id` ASC),
  INDEX `fk_PaymentData_Paypal1_idx` (`Paypal_id` ASC),
  ...
  CONSTRAINT `fk_PaymentData_CreditCard1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PaymentData_DirectDebit1`
    FOREIGN KEY (`DirectDebit_id`)
    REFERENCES `Drueckler3DDrucke`.`DirectDebit` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PaymentData_Bill1`
    FOREIGN KEY (`Bill_id`)
    REFERENCES `Drueckler3DDrucke`.`Bill` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PaymentData_Paypal1`
    FOREIGN KEY (`Paypal_id`)
    REFERENCES `Drueckler3DDrucke`.`Paypal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`ContactData` (
  ...
  UNIQUE INDEX `AddressID_UNIQUE` (`Address_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`Customer` (
  ...
  `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `PaymentData_id` INT NULL,
  `guest` TINYINT NOT NULL DEFAULT 0,
  `ContactData_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `PaymentID_UNIQUE` (`PaymentData_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`Pricing` (
  ...
  `grammsPerMinute` DECIMAL(6,2) NOT NULL,
