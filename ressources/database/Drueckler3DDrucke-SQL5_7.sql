...
CREATE TABLE IF NOT EXISTS `Drueckler3DDrucke`.`PrintConfig` (
  ...
  UNIQUE INDEX `Models_id_UNIQUE` (`Models_id` ASC),
  UNIQUE INDEX `Filaments_id_UNIQUE` (`Filaments_id` ASC),
  UNIQUE INDEX `PrintSettings_id_UNIQUE` (`PrintSettings_id` ASC),
